...
for v in range(len(varnames)):
    ...
    diff_FICFIT = np.nanmean(tas_fm[3] - tas_fm[1],axis=0)
    ...
    stat_FICFIT,pvalue_FICFIT = UT.calc_indttest(tas_fm[3],tas_fm[1])
    ...
    plt.savefig(directoryfigure + 'allExperiments_FM_%s.png' % varnames[v],
                dpi=300)
