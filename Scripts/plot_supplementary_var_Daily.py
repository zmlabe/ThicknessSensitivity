...
for v in range(len(varnames)):
    ...
    ### Add experiments
    plt.annotate(r'%s' % experiments[0],xy=(0,0),xytext=(0.233,0.91),
                 textcoords='figure fraction',color='dimgrey',
                 fontsize=19,ha='center',va='center')
    plt.annotate(r'%s' % experiments[1],xy=(0,0),xytext=(0.515,0.91),
                 textcoords='figure fraction',color='dimgrey',
                 fontsize=19,ha='center',va='center')
    plt.annotate(r'%s' % experiments[2],xy=(0,0),xytext=(0.795,0.91),
                 textcoords='figure fraction',color='dimgrey',
                 fontsize=19,ha='center',va='center')
    ...
    plt.savefig(directoryfigure + 'supplementary_%s_daily.png' % varnames[v],
                dpi=300)
