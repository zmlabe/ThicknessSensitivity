...
lat,lon,time,lev,div_f = MO.readExperi(directorydata,'DEPF','FICT','profile')
...
diff_epy = np.nanmean(epy_mof - epy_moh,axis=0)
diff_epz = np.nanmean(epz_mof - epz_moh,axis=0)
diff_div = np.nanmean(div_mof - div_moh,axis=0)/30.
